...
- **Placement:** centered, `width: min(1600px, 132vw)`, inside the fixed backdrop
  layer. A single faint teal wash sits beneath for brand-secondary presence.
...
--facet-layout:   position:fixed; centered; min(1600px,132vw); clear center; edge dissolve;
```
